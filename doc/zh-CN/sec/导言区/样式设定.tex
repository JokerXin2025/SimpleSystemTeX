...
并非所有显示参数都是为了显示内容而存在, 例如您可能因为 \texttt{@section} 中存在特殊字符而使用 \texttt{@sectionname} 作为替用名称, 此时 \texttt{@section} 应当用于提供节文件名称以供条件判断, 而 \texttt{@sectionname} 则用于显示在文档中. 请根据实际需求选择合适的显示参数来编写样式代码.

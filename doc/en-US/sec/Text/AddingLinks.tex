...
The link will be rendered using \meta{link text} as its display content. If this argument is omitted, \SimpleSystemTeX will apply a default link display style. You can modify the relevant display logic by altering the style code in the \seclink{Preamble/Style Configuration}(Style Configuration).

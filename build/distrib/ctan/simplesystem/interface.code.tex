...
\NewDocumentCommand \ImportSection {v d() d<>} {
    ...
    \_preprocess_section:nVV {#1} \l_@@_interface_arga_tl \l_@@_interface_argb_tl
...
\NewDocumentCommand \NewBlockType {s m} {
    ...
    \regex_match:nnTF {^[a-zA-Z]+$} {#2} {
        ...
        \IfBooleanTF {#1} {
            \_declare_anonymous_block_type:n {#2}
        } {
            \_declare_block_type:n {#2}
        }
...
\NewDocumentCommand \MakeBlockIndex {s v d[] d<>} {
    ...
    \IfBooleanTF {#1} {
        \_generate_block_index:NnVV \c_false_bool {#2} \l_@@_interface_arga_tl \l_@@_interface_argb_tl
    } {
        \_generate_block_index:NnVV \c_true_bool {#2} \l_@@_interface_arga_tl \l_@@_interface_argb_tl
    }
...
\NewDocumentCommand \seclink {m d()} {
    ...
    \_add_section_link:eV {\tl_to_str:e {#1}} \l_@@_interface_arga_tl
...
\NewDocumentCommand \blclink {m d()} {
    ...
    \_add_block_link:eV {#1} \l_@@_interface_arga_tl
...
\NewDocumentCommand \indlink {m d()} {
    ...
    \_add_index_link:eV {\tl_to_str:e {#1}} \l_@@_interface_arga_tl
